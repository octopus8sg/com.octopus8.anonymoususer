 ...
 */
class CRM_Anonymoususer_Upgrader_Base {

  /**
   * @var CRM_Anonymoususer_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Anonymoususer_Upgrader(
        'com.octopus8.anonymoususer',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Anonymoususer_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Anonymoususer_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
